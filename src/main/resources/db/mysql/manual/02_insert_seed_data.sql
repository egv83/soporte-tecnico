...
('CLI-001', 'Juan Carlos', 'Pérez Rodríguez', 'jc.perez@techsolutions.com', '+34 911 234 567', 'Tech Solutions S.A.',
 TRUE),
('CLI-002', 'María Dolores', 'González López', 'md.gonzalez@techsolutions.com', '+34 911 234 568',
 'Tech Solutions S.A.', TRUE),
('CLI-003', 'Luis Miguel', 'Sánchez García', 'lm.sanchez@techsolutions.com', '+34 911 234 569', 'Tech Solutions S.A.',
 TRUE),

-- Empresa Digital Innovations
('CLI-004', 'Ana Belén', 'Martínez Ruiz', 'ab.martinez@digitalinnovations.com', '+34 922 345 678',
 'Digital Innovations S.L.', TRUE),
('CLI-005', 'Carlos Javier', 'Rodríguez Fernández', 'cj.rodriguez@digitalinnovations.com', '+34 922 345 679',
 'Digital Innovations S.L.', TRUE),
...
-- Otras empresas
('CLI-008', 'Sofía', 'Torres Mendoza', 'sofia.torres@cloudservices.com', '+34 944 567 890', 'Cloud Services S.A.',
 TRUE),
...
WHERE id = 1; -- Carlos a ticket 1
UPDATE ticket
SET tecnico_asignado_id = 4
WHERE id = 3; -- Carmen a ticket 3
UPDATE ticket
SET tecnico_asignado_id = 5
WHERE id = 4; -- Andrés a ticket 4
UPDATE ticket
SET tecnico_asignado_id = 7
WHERE id = 5; -- Elena a ticket 5
UPDATE ticket
SET tecnico_asignado_id = 3
WHERE id = 6; -- Miguel a ticket 6
UPDATE ticket
SET tecnico_asignado_id = 6
WHERE id = 8; -- Roberto a ticket 8
UPDATE ticket
SET tecnico_asignado_id = 4
WHERE id = 9; -- Carmen a ticket 9
UPDATE ticket
SET tecnico_asignado_id = 3
WHERE id = 10;
-- Miguel a ticket 10
...
UPDATE ticket
SET fecha_cierre            = DATE_SUB(NOW(), INTERVAL 8 DAY),
    tiempo_resolucion_horas = 48
WHERE id = 6;
UPDATE ticket
SET fecha_cierre            = DATE_SUB(NOW(), INTERVAL 12 DAY),
    tiempo_resolucion_horas = 72
WHERE id = 7;
UPDATE ticket
SET fecha_cierre            = DATE_SUB(NOW(), INTERVAL 5 DAY),
    tiempo_resolucion_horas = 36
WHERE id = 8;
...
VALUES ('Buen día, mi PC no enciende desde la actualización de Windows', FALSE, 1, 1, DATE_SUB(NOW(), INTERVAL 5 DAY));

INSERT INTO comentario (contenido, es_interno, ticket_id, tecnico_id, fecha_creacion)
VALUES ('Revisando el caso, se programará visita técnica', TRUE, 1, 1, DATE_SUB(NOW(), INTERVAL 4 DAY));

-- Comentarios para ticket 3 (VPN)
INSERT INTO comentario (contenido, es_interno, ticket_id, cliente_id, fecha_creacion)
VALUES ('El problema es muy grave, afecta a toda la empresa', FALSE, 3, 4, DATE_SUB(NOW(), INTERVAL 2 DAY));

INSERT INTO comentario (contenido, es_interno, ticket_id, tecnico_id, fecha_creacion)
VALUES ('Inicio investigación del problema de VPN', TRUE, 3, 4, DATE_SUB(NOW(), INTERVAL 2 DAY));

INSERT INTO comentario (contenido, es_interno, ticket_id, tecnico_id, fecha_creacion)
VALUES ('Contactando con proveedor de internet', TRUE, 3, 4, DATE_SUB(NOW(), INTERVAL 1 DAY));

INSERT INTO comentario (contenido, es_interno, ticket_id, cliente_id, fecha_creacion)
VALUES ('Sigue sin funcionar la VPN, necesito una solución urgente', FALSE, 3, 4, DATE_SUB(NOW(), INTERVAL 1 DAY));

INSERT INTO comentario (contenido, es_interno, ticket_id, tecnico_id, fecha_creacion)
VALUES ('¿Podría confirmar si el problema persiste?', FALSE, 3, 4, DATE_SUB(NOW(), INTERVAL 12 HOUR));

-- Comentarios para ticket 4 (Base de datos)
INSERT INTO comentario (contenido, es_interno, ticket_id, cliente_id, fecha_creacion)
VALUES ('Las consultas están muy lentas, el sistema está casi inoperable', FALSE, 4, 6,
        DATE_SUB(NOW(), INTERVAL 2 DAY));

INSERT INTO comentario (contenido, es_interno, ticket_id, tecnico_id, fecha_creacion)
VALUES ('Analizando queries lentas', TRUE, 4, 5, DATE_SUB(NOW(), INTERVAL 1 DAY));

INSERT INTO comentario (contenido, es_interno, ticket_id, tecnico_id, fecha_creacion)
VALUES ('Se identificaron índices faltantes', TRUE, 4, 5, DATE_SUB(NOW(), INTERVAL 6 HOUR));

INSERT INTO comentario (contenido, es_interno, ticket_id, tecnico_id, fecha_creacion)
VALUES ('Optimización aplicada, mejoró un 80% el rendimiento', FALSE, 4, 5, NOW());

-- Comentarios para ticket 5 (Error autenticación)
INSERT INTO comentario (contenido, es_interno, ticket_id, cliente_id, fecha_creacion)
VALUES ('Los usuarios no pueden iniciar sesión, es crítico', FALSE, 5, 7, DATE_SUB(NOW(), INTERVAL 1 DAY));

INSERT INTO comentario (contenido, es_interno, ticket_id, tecnico_id, fecha_creacion)
VALUES ('Revisando logs de autenticación', TRUE, 5, 7, DATE_SUB(NOW(), INTERVAL 23 HOUR));

INSERT INTO comentario (contenido, es_interno, ticket_id, tecnico_id, fecha_creacion)
VALUES ('Se detectó un problema con el LDAP', TRUE, 5, 7, DATE_SUB(NOW(), INTERVAL 12 HOUR));

-- Comentarios para ticket 6 (Correo saliente - resuelto)
INSERT INTO comentario (contenido, es_interno, ticket_id, cliente_id, fecha_creacion)
VALUES ('Los correos no salen, lleva 2 días así', FALSE, 6, 3, DATE_SUB(NOW(), INTERVAL 10 DAY));

INSERT INTO comentario (contenido, es_interno, ticket_id, tecnico_id, fecha_creacion)
VALUES ('Revisando configuración del servidor SMTP', TRUE, 6, 3, DATE_SUB(NOW(), INTERVAL 9 DAY));

INSERT INTO comentario (contenido, es_interno, ticket_id, tecnico_id, fecha_creacion)
VALUES ('Se reinició el servicio de correo', TRUE, 6, 3, DATE_SUB(NOW(), INTERVAL 9 DAY));

INSERT INTO comentario (contenido, es_interno, ticket_id, cliente_id, fecha_creacion)
VALUES ('Excelente servicio, problema resuelto', FALSE, 6, 3, DATE_SUB(NOW(), INTERVAL 8 DAY));

-- Comentarios para ticket 8 (Sitio web lento)
INSERT INTO comentario (contenido, es_interno, ticket_id, cliente_id, fecha_creacion)
VALUES ('El sitio web está muy lento, los clientes se quejan', FALSE, 8, 8, DATE_SUB(NOW(), INTERVAL 7 DAY));

INSERT INTO comentario (contenido, es_interno, ticket_id, tecnico_id, fecha_creacion)
VALUES ('Optimizando caché del servidor web', TRUE, 8, 6, DATE_SUB(NOW(), INTERVAL 6 DAY));

INSERT INTO comentario (contenido, es_interno, ticket_id, tecnico_id, fecha_creacion)
VALUES ('Se mejoró la configuración del CDN', FALSE, 8, 6, DATE_SUB(NOW(), INTERVAL 5 DAY));

INSERT INTO comentario (contenido, es_interno, ticket_id, cliente_id, fecha_creacion)
VALUES ('El sitio funciona mucho mejor, gracias', FALSE, 8, 8, DATE_SUB(NOW(), INTERVAL 5 DAY));
...
INSERT INTO historial_ticket (ticket_id, campo_modificado, valor_anterior, valor_nuevo, usuario_modifico,
                              fecha_modificacion)
VALUES (3, 'estado', 'ABIERTO', 'EN_PROCESO', 'carmen.moreno@soporte.com', DATE_SUB(NOW(), INTERVAL 2 DAY)),
...
VALUES ('admin', '$2a$10$6g2CeyOg2FKniIMhrGmomuL8N90HctwCKmhS8oJ45F3csVaxDQJHC', 'ADMIN', TRUE, TRUE,
        TRUE, TRUE,NOW()),
